...
export function ModalAddMember({ isOpen, onOpenChange, onCancel }: ModalAddMemberProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response: AxiosResponse<FormResponse> = await api.post('/admin/auth/register', formObject);
      if (response.success) {
        onOpenChange(false);
